	...
	<div class="container">
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-3 col-lg-3">
				<div class="head_mobile_menu_left arrow_bottom hidden-md hidden-lg">Услуги</div>
				<?$APPLICATION->IncludeComponent(
					"bitrix:menu",
					"shop_services_vertical",
					array(
						...
						"ROOT_MENU_TYPE" => "left",
						"USE_EXT" => "Y",
						"COMPONENT_TEMPLATE" => "shop_services_vertical"
					),
					false
				);?>
			</div>
			<div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
				<?$APPLICATION->IncludeComponent(
					...
					array(
						...
						"MESS_SHOW_MAX_QUANTITY" => "На складе",
						"MIN_AMOUNT" => "10",
						...
						"USE_STORE" => "N",
						"COMPONENT_TEMPLATE" => "for_services_page",
