	...
	<div class="container">
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<form action="" method="get"  class="reg_wrapper">
					<div class="row">
						<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
							...
							<?else:?>
								<input class="input_site input_site_dark" type="text" name="q" value="<?=$arResult["REQUEST"]["QUERY"]?>" style="margin:0;"/>
							<?endif;?>
						</div>
						<div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
							<?if($arParams["SHOW_WHERE"]):?>
								<select class="input_site input_site_dark" name="where" style="margin:0;">
						...
						<div class="col-xs-9 col-sm-3 col-md-3 col-lg-3">
							<input class="btn_site btn_transparent" type="submit" value="<?=GetMessage("SEARCH_GO")?>" />
				...
				<?elseif(count($arResult["SEARCH"])>0):?>
					...
					<?foreach($arResult["SEARCH"] as $arItem):?>
						<a href="<?echo $arItem["URL"]?>" style="font-size:4rem;"><?echo $arItem["TITLE_FORMATED"]?></a>
