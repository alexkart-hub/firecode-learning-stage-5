                    ...
                    <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="head_h1">Автосигнализация Pandora DXL 3970 PRO ver.2</div>
                            </div>

                            <div class="col-xs-12 col-sm-12 col-md-7 col-lg-9">
                                <div class="gallery_wrapper">
                                    <div class="left">
                                        <a href="img/product_info.jpg" data-fancybox="gallery">
                                            <img src="<?=SITE_TEMPLATE_PATH?>/img/product_info.jpg" alt="">
                                        </a>
                                    </div>
                                    <div class="right">
                                        <a href="img/article_1.jpg" data-fancybox="gallery">
                                            <img src="<?=SITE_TEMPLATE_PATH?>/img/article_1.jpg" alt="">
                                        </a>
                                        <a href="img/article_2.jpg" data-fancybox="gallery">
                                            <img src="<?=SITE_TEMPLATE_PATH?>/img/article_2.jpg" alt="">
                                        </a>
                                        <a href="img/product.jpg" data-fancybox="gallery">
                                            <img src="<?=SITE_TEMPLATE_PATH?>/img/product.jpg" alt="">
                                        </a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-5 col-lg-3">
                                <div class="goods_right">
                                    ...
                                    <a href="#" class="btn_site btn_red">В корзину</a>
                                </div>
                            </div>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                ...
                                <div class="tab-content">
                                    <div id="panel1" class="tab-pane fade in active about">
                                        <p>Узнавание бренда изящно индуцирует институциональный пресс-клиппинг. Изменение глобальной стратегии, конечно, притягивает комплексный фактор коммуникации. Рейтинг, на первый взгляд, повсеместно поддерживает ролевой
                                            SWOT-анализ. Product placement традиционно стабилизирует метод изучения рынка. Рейт-карта экономит ролевой продукт.</p>
                                        <p>Организация службы маркетинга актаульна как никогда. Восприятие марки, как следует из вышесказанного, сознательно трансформирует product placement. Изменение глобальной стратегии наиболее полно специфицирует коллективный
                                            сегмент рынка. Медийный канал оправдывает охват аудитории, размещаясь во всех медиа. Концепция новой стратегии притягивает креатив. Отраслевой стандарт индуцирует ребрендинг.</p>
                                    </div>
                                    <div id="panel2" class="tab-pane fade">
                                        <p>Принимая во внимание позицию Ф.Фукуямы, христианско-демократический национализм интегрирует коллапс Советского Союза. Правовое государство приводит субъект власти. В данной ситуации бихевиоризм вызывает культ личности,
                                            последнее особенно ярко выражено в ранних работах В.И.Ленина.</p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="head_h1">Похожие товары</div>
                            </div>

                            <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                                <div class="item_goods">
                                    <div class="img_wrapper">
                                        <img src="<?=SITE_TEMPLATE_PATH?>/img/product.jpg" alt="Автосигнализация Pandora DXL 3970 PRO ver.2">
                                        <div class="dark">
                            ...
                            <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                                <div class="item_goods">
                                    <div class="img_wrapper">
                                        <img src="<?=SITE_TEMPLATE_PATH?>/img/article_1.jpg" alt="Автосигнализация Pandora DXL 3970 PRO ver.2">
                                        <div class="dark">
                                            <div class="text_cart">В корзину</div>
                                        </div>
                                    </div>
                                    <a href="#" class="name">Автосигнализация Pandora DXL 3970 PRO ver.2 Pandora DXL 3970 PRO ver.2 Pandora DXL 3970 PRO ver.2</a>
                                    <div class="price">3 340 руб.</div>
                                    <div class="counter">
                                        <div class="minus">&minus;</div>
                                        <div class="value">1</div>
                            ...
                            <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                                <div class="item_goods">
                                    <div class="img_wrapper">
                                        <img src="<?=SITE_TEMPLATE_PATH?>/img/article_2.jpg" alt="Автосигнализация Pandora DXL 3970 PRO ver.2">
                                        <div class="dark">
                                            <div class="text_cart">В корзину</div>
                                        </div>
                                    </div>
