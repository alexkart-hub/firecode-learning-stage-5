...
<div class="filter_left">
	<div class="filter_big_head">Фильтры</div>

	<div class="filter_item">
		<div class="head_filter arrow_bottom">Цена:</div>
		<div class="content">
			<div class="slider">
				<div class="left_slider">
					<div class="text">4 500</div>
				</div>
	...
	<div class="filter_item">
		<div class="head_filter arrow_bottom">Производитель:</div>
		<div class="content">
			<label class='label_wrapper'>
				<input type='checkbox' class='checkbox' name=''>
				<span class='checkbox-custom'></span>
				<span class='label_text'>Starline</span>
			</label>
			<label class='label_wrapper'>
				<input type='checkbox' class='checkbox' name=''>
				<span class='checkbox-custom'></span>
				<span class='label_text'>Pandora</span>
			</label>
			<label class='label_wrapper'>
				<input type='checkbox' class='checkbox' name=''>
				<span class='checkbox-custom'></span>
				<span class='label_text'>Pandeck</span>
			</label>
			<label class='label_wrapper'>
				<input type='checkbox' class='checkbox' name=''>
				<span class='checkbox-custom'></span>
				<span class='label_text'>Scher-Khan</span>
			</label>
			<label class='label_wrapper'>
				<input type='checkbox' class='checkbox' name=''>
				<span class='checkbox-custom'></span>
				<span class='label_text'>Sheriff</span>
			</label>
		</div>
	</div>

	<div class="filter_item">
		<div class="head_filter arrow_bottom">Тип:</div>
		<div class="content">
			<label class='label_wrapper'>
				<input type='checkbox' class='checkbox' name=''>
				<span class='checkbox-custom'></span>
				<span class='label_text'>диалоговый код</span>
			</label>
			<label class='label_wrapper'>
				<input type='checkbox' class='checkbox' name=''>
				<span class='checkbox-custom'></span>
				<span class='label_text'>обратная связь</span>
			</label>
			<label class='label_wrapper'>
				<input type='checkbox' class='checkbox' name=''>
				<span class='checkbox-custom'></span>
				<span class='label_text'>запуск двигателя</span>
			</label>
			<label class='label_wrapper'>
				<input type='checkbox' class='checkbox' name=''>
				<span class='checkbox-custom'></span>
				<span class='label_text'>режим турботаймера</span>
			</label>
			<label class='label_wrapper'>
				<input type='checkbox' class='checkbox' name=''>
				<span class='checkbox-custom'></span>
				<span class='label_text'>модуль CAN</span>
			</label>
			<label class='label_wrapper'>
				<input type='checkbox' class='checkbox' name=''>
				<span class='checkbox-custom'></span>
				<span class='label_text'>модуль GSM</span>
			</label>
			<label class='label_wrapper'>
				<input type='checkbox' class='checkbox' name=''>
				<span class='checkbox-custom'></span>
				<span class='label_text'>модуль GPS</span>
			</label>
			<label class='label_wrapper'>
				<input type='checkbox' class='checkbox' name=''>
				<span class='checkbox-custom'></span>
				<span class='label_text'>3D датчик</span>
			</label>
			<label class='label_wrapper'>
				<input type='checkbox' class='checkbox' name=''>
				<span class='checkbox-custom'></span>
				<span class='label_text'>иммобилайзер</span>
			</label>
			<label class='label_wrapper'>
				<input type='checkbox' class='checkbox' name=''>
				<span class='checkbox-custom'></span>
				<span class='label_text'>управление штатным брелком</span>
			</label>
		</div>
	</div>

	<div class="filter_item">
		<div class="head_filter arrow_bottom">Товар:</div>
		<div class="content">
			<label class='label_wrapper half'>
				<input type='checkbox' class='checkbox' name=''>
				<span class='checkbox-custom'></span>
			...
			<label class='label_wrapper half'>
				<input type='checkbox' class='checkbox' name=''>
				<span class='checkbox-custom'></span>
				<span class='label_text'>под заказ</span>
			</label>
		</div>
	</div>

	<div class="filter_item">
		<div class="head_filter arrow_bottom">Статус:</div>
		<div class="content">
			<label class='label_wrapper half'>
				<input type='checkbox' class='checkbox' name=''>
				<span class='checkbox-custom'></span>
			...
			<label class='label_wrapper half'>
				<input type='checkbox' class='checkbox' name=''>
				<span class='checkbox-custom'></span>
				<span class='label_text'>новинка</span>
			</label>
			<label class='label_wrapper half'>
				<input type='checkbox' class='checkbox' name=''>
				<span class='checkbox-custom'></span>
				<span class='label_text'>распродажа</span>
			</label>
			<label class='label_wrapper half'>
				<input type='checkbox' class='checkbox' name=''>
				<span class='checkbox-custom'></span>
				<span class='label_text'>акции</span>
			</label>
		</div>
	</div>

	<div class="btn_site btn_red">Показать</div>
	<div class="btn_site btn_transparent">Сбросить фильтр</div>

</div>
*/?>
<div class="filter_left" <?if ($arParams["SHOW_TEMPLATE"] == "N"):?> style="display:none;"<?endif?>>
	<div class="filter_big_head"><?echo GetMessage("CT_BCSF_FILTER_TITLE")?></div>
	<form name="<?echo $arResult["FILTER_NAME"]."_form"?>" action="<?echo $arResult["FORM_ACTION"]?>" method="get" class="smartfilter">
		...
		foreach($arResult["ITEMS"] as $key=>$arItem)
		{
			...
			if(isset($arItem["PRICE"])):
				...
				?>
				<div class="filter_item <?if ($arItem["DISPLAY_EXPANDED"]== "Y"):?>active<?endif?>">
					<div class="head_filter arrow_bottom"><?=$arItem["NAME"]?></div>
					<div class="content" id="drag_track_<?=$key?>">
						<?
						...
						?>
						<div class="slider" id="drag_tracker_<?=$key?>"  style="left: 0%; right: 0%;">
							<div class="left_slider" id="left_slider_<?=$key?>" style="left:0;">
								<input class="text" id="<?echo $arItem["VALUES"]["MIN"]["CONTROL_ID"]?>"  name="<?echo $arItem["VALUES"]["MIN"]["CONTROL_NAME"]?>" value="<?echo $arItem["VALUES"]["MIN"]["HTML_VALUE"]?>" style="background-color:transparent; border:none;">
							</div>
							<div class="center" style="left: 0;right: 0;"  id="colorUnavailableActive_<?=$key?>"></div>
							<div class="center" style="left: 0;right: 0; background-color:#484953;" id="colorAvailableInactive_<?=$key?>"></div>
							<div class="center" style="left: 0;right: 0;" id="colorAvailableActive_<?=$key?>"></div>
							<div class="right_slider" id="right_slider_<?=$key?>" style="right:0;">
								<input class="text" id="<?echo $arItem["VALUES"]["MAX"]["CONTROL_ID"]?>"  name="<?echo $arItem["VALUES"]["MAX"]["CONTROL_NAME"]?>" value="<?echo $arItem["VALUES"]["MAX"]["HTML_VALUE"]?>" style="background-color:transparent; border:none;">
							</div>
						</div>
					</div>
				</div>
					...
					<div class="content">
						...
						switch ($arItem["DISPLAY_TYPE"])
						{
							...
							case "K"://RADIO_BUTTONS
								?>
								<label class="label_wrapper" for="<? echo "all_".$arCur["CONTROL_ID"] ?>">
									<input
										type="radio"
										value=""
										...
										/>
									<span class="label_text"><? echo GetMessage("CT_BCSF_FILTER_ALL"); ?></span>
								</label>
								<?foreach($arItem["VALUES"] as $val => $ar):?>
									<label data-role="label_<?=$ar["CONTROL_ID"]?>" class="label_wrapper" for="<? echo $ar["CONTROL_ID"] ?>">
										<input
											type="radio"
											value="<? echo $ar["HTML_VALUE_ALT"] ?>"
											...
											onclick="smartFilter.click(this)"
											/>
										<span class="label_text" title="<?=$ar["VALUE"];?>"><?=$ar["VALUE"];?><?
											if ($arParams["DISPLAY_ELEMENT_COUNT"] !== "N" && isset($ar["ELEMENT_COUNT"])):
												?> (<span data-role="count_<?=$ar["CONTROL_ID"]?>"><? echo $ar["ELEMENT_COUNT"]; ?></span>)<?
											endif;?></span>
							...
							default://CHECKBOXES
								?>
								<?foreach($arItem["VALUES"] as $val => $ar):?>
									<label data-role="label_<?=$ar["CONTROL_ID"]?>" class="label_wrapper <? echo $ar["DISABLED"] ? 'disabled': '' ?>" for="<? echo $ar["CONTROL_ID"] ?>">
										<input
											type="checkbox"
	...
	<input
		...
		/>
	<input
		class="btn_site btn_transparent"
		type="submit"
		id="del_filter"
		name="del_filter"
		...
		<div style="display:none;">
			<div  id="modef" <?if(!isset($arResult["ELEMENT_COUNT"])) echo 'style="display:none"';?> style="display: inline-block;">
