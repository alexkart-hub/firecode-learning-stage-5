...
?>
<?//print_r($arResult);?>
<label data-bx-user-consent="<?=htmlspecialcharsbx($config)?>" class='label_wrapper'>
	<input type='checkbox' class='checkbox'  value="Y" <?=($arParams['IS_CHECKED'] ? 'checked' : '')?> name="<?=htmlspecialcharsbx($arParams['INPUT_NAME'])?>">
	<span class='checkbox-custom'></span>
	<span class='label_text'>Принимаю <a href="/soglasie.php" target="_blank"><?=htmlspecialcharsbx($arResult['INPUT_LABEL'])?></a></span>
</label>
