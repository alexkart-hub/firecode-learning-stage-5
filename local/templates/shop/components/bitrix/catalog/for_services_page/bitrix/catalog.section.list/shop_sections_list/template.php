...
if ('Y' == $arParams['SHOW_PARENT_NAME'] && 0 < $arResult['SECTION']['ID'])
{
	...
	?>
	<div class="row" id="<? echo $this->GetEditAreaId($arResult['SECTION']['ID']); ?>">
		...
		case 'TILE':
			...
			foreach ($arResult['SECTIONS'] as &$arSection)
			{
				...
				?>
					...
					<div class="col-xs-12 col-sm-6 col-md-4 col-lg-4" id="<? echo $this->GetEditAreaId($arSection['ID']); ?>">
						<div class="item_sound">
							<a href="<? echo $arSection['SECTION_PAGE_URL']; ?>" class="wrapper_grey">
								<div class="img_wrapper">
									<img src="<? echo $arSection['PICTURE']['SRC']; ?>" alt="<? echo $arSection['PICTURE']['ALT']; ?>" title="<? echo $arSection['PICTURE']['TITLE']; ?>">
								</div>
								<div class="name" style="height:50px;"><? echo $arSection['NAME']; ?></div>
								<div class="dark">
