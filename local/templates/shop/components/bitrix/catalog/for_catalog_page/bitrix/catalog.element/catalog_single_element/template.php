...
<div class="row" id="<? echo $arItemIDs['ID']; ?>">
	...
	<div class="col-xs-12 col-sm-12 col-md-7 col-lg-9">
		<div class="gallery_wrapper">
			<div class="left">
				<a href="<? echo $arResult['DETAIL_PICTURE']['SRC']; ?>" data-fancybox="gallery">
					<img src="<? echo $arResult['DETAIL_PICTURE']['SRC']; ?>" alt="<? echo $arResult['DETAIL_PICTURE']['ALT']; ?>" title="<? echo $arResult['DETAIL_PICTURE']['TITLE']; ?>">
				</a>
			</div>
			<div class="right">
				<?if(!empty($arResult['PROPERTIES']['MORE_PHOTO']['VALUE'])):?>
					<?$photoIds=$arResult['PROPERTIES']['MORE_PHOTO']['VALUE']?>
				<?endif;?>
				<?$count=0;?>
	...
	<div class="col-xs-12 col-sm-12 col-md-5 col-lg-3">
		...
		<div class="goods_right">
			...
			<div class="price" id="<? echo $arItemIDs['PRICE']; ?>"><? echo $minPrice['PRINT_DISCOUNT_VALUE']; ?></div>
			...
			<div class="counter">
				<div class="minus" id="<? echo $arItemIDs['QUANTITY_DOWN']; ?>">&minus;</div>
				<div class="value" id="<? echo $arItemIDs['QUANTITY']; ?>">1</div>
				<div class="plus" id="<? echo $arItemIDs['QUANTITY_UP']; ?>">&plus;</div>
			</div>
			<div class="storage">На складе: <strong><?=$arResult['CATALOG_QUANTITY']?> шт.</strong></div>
			<a href="<?$arResult['ADD_URL']?>" class="btn_site btn_red">В корзину</a>
		</div>
		...
		<div class="goods_right">
			...
			<div class="storage">На складе: <strong>25 шт.</strong></div>
			<a href="<?$arResult['ADD_URL']?>" class="btn_site btn_red">В корзину</a>
		</div>
	...
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<ul class="nav nav-tabs tab_site">
			...
			<li>
				<a href="#panel2" class="tab_map">Характеристики</a>
			</li>
		</ul>
		<div class="tab-content">
			<div id="panel1" class="tab-pane fade in active about">
				<p>Узнавание бренда изящно индуцирует институциональный пресс-клиппинг. Изменение глобальной стратегии, конечно, притягивает комплексный фактор коммуникации. Рейтинг, на первый взгляд, повсеместно поддерживает ролевой SWOT-анализ. Product placement традиционно стабилизирует метод изучения рынка. Рейт-карта экономит ролевой продукт.</p>
				<p>Организация службы маркетинга актаульна как никогда. Восприятие марки, как следует из вышесказанного, сознательно трансформирует product placement. Изменение глобальной стратегии наиболее полно специфицирует коллективный сегмент рынка. Медийный канал оправдывает охват аудитории, размещаясь во всех медиа. Концепция новой стратегии притягивает креатив. Отраслевой стандарт индуцирует ребрендинг.</p>
			</div>
			<div id="panel2" class="tab-pane fade">
				<p>Принимая во внимание позицию Ф.Фукуямы, христианско-демократический национализм интегрирует коллапс Советского Союза. Правовое государство приводит субъект власти. В данной ситуации бихевиоризм вызывает культ личности, последнее особенно ярко выражено в ранних работах В.И.Ленина.</p>
			</div>
		</div>
	</div>
			...
			<div  class="gallery_wrapper" id="<? echo $arItemIDs['BIG_SLIDER_ID']; ?>">
				...
				if ($arResult['SHOW_SLIDER'])
				{
					if (!isset($arResult['OFFERS']) || empty($arResult['OFFERS']))
					{
						...
						?>
						<div class="right" id="<? echo $arItemIDs['SLIDER_CONT_ID']; ?>">
							<?
							$count=0;
							foreach ($arResult['MORE_PHOTO'] as &$arOnePhoto)
							{
								if (++$count>3) break;
								?>
								<a href="<?=$arOnePhoto['SRC'];?>" data-fancybox="gallery">
				...
				if ($arParams['USE_PRODUCT_QUANTITY'] == 'Y')
				{
					if ($arParams['SHOW_BASIS_PRICE'] == 'Y')
					{
						...
						*/?>
						...
						<div class="counter">
							<a href="javascript:void(0)" class="minus" id="<? echo $arItemIDs['QUANTITY_DOWN']; ?>">&minus;</a>
							<input id="<? echo $arItemIDs['QUANTITY']; ?>" type="text" class="value" value="<? echo (isset($arResult['OFFERS']) && !empty($arResult['OFFERS'])
									? 1
									: $arResult['CATALOG_MEASURE_RATIO']
								); ?>"
							style="border:none; padding:0;">
							<a href="javascript:void(0)" class="plus" id="<? echo $arItemIDs['QUANTITY_UP']; ?>">&plus;</a>
						</div>
						<div class="storage">На складе: <strong><?=$arResult['CATALOG_QUANTITY']?> шт.</strong></div>
						<span id="<? echo $arItemIDs['BASKET_ACTIONS']; ?>" style="display: <? echo ($canBuy ? '' : 'none'); ?>;">
							<?
								...
								{
							?>
								<a href="javascript:void(0);" class="btn_site btn_red" id="<? echo $arItemIDs['BUY_LINK']; ?>"><span></span><? echo $buyBtnMessage; ?></a>
							<?
								}
								if ($showAddBtn)
								{
							?>
								<?//Наша кнопка?>
								<a href="javascript:void(0);" class="btn_site btn_red" id="<? echo $arItemIDs['ADD_BASKET_LINK']; ?>"><span></span><? echo $addToBasketBtnMessage; ?></a>
							<?
								}
							?>
						</span>
