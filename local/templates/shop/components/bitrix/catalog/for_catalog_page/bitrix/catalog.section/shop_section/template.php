...
if (!empty($arResult['ITEMS']))
{
	...
	<?$strSort = ($arParams["ELEMENT_SORT_ORDER"] == "asc") ? "цена (по возрастанию)" : "цена (по убыванию)";?>
	<div class="col-xs-12">
			...
			<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
				<div class="item_goods" id="<? echo $strMainID; ?>">
					<div class="img_wrapper">
						<img src="<? echo $arItem['PREVIEW_PICTURE']['SRC']; ?>" alt="<? echo $imgTitle; ?>" title="<? echo $imgTitle; ?>">
						<a href="<?=$arItem['DETAIL_PAGE_URL'];?>">
							<div class="dark">
								<div class="text_cart"><?=GetMessage('CT_BCS_TPL_MESS_BTN_DETAIL')?></div>
							</div>
						</a>
					</div>
						<?
					...
					if (!isset($arItem['OFFERS']) || empty($arItem['OFFERS']))
					{
						...
						<?
									if ($arItem['CAN_BUY'])
									{
										...
										?>
										<div class="col-xs-12">
											<div class="buy_button" id="<? echo $arItemIDs['BASKET_ACTIONS']; ?>" >
...
<?/*
		<?$APPLICATION->IncludeComponent(
			...
			array(
				...
				"CACHE_TYPE" => "A",
				"CHECK_DATES" => "N",
				"DETAIL_URL" => "/our_works/#SECTION_CODE#/#ELEMENT_CODE#/",
		...
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			<div class="head_h1">СЕО текст</div>
