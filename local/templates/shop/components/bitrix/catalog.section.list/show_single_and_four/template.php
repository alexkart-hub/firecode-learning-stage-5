...
?><div class="container" id="<? echo $this->GetEditAreaId($arResult['SECTION']['ID']); ?>"><?
		...
		case 'TILE':
			...
			foreach ($arResult['SECTIONS'] as &$arSection)
			{
				...
				if ($arSection['UF_SHOW_ON_MAIN']) {
					++$localCount;
					if($localCount > $arParams['SHOW_SECTION_COUNT']) break;
					if (false === $arSection['PICTURE'])
						$arSection['PICTURE'] = array(
							'SRC' => $arCurView['EMPTY_IMG'],
							'ALT' => (
					...
					?>
					<div class="col-xs-12 col-sm-6 col-md-3 col-lg-3" id="<? echo $this->GetEditAreaId($arSection['ID']); ?>">
