...
if (isset($arResult['REQUEST_ITEMS']))
{
	...
	<d.0iv class="row" id="<?=$injectId?>"></d.0iv>
...
<div class="row">
	...
	<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
		<div class="item_goods">
			<div class="img_wrapper">
				<img src="img/product.jpg" alt="Автосигнализация Pandora DXL 3970 PRO ver.2">
				<div class="dark">
	...
	<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
		<div class="item_goods">
			<div class="img_wrapper">
				<img src="img/article_1.jpg" alt="Автосигнализация Pandora DXL 3970 PRO ver.2">
				<div class="dark">
					<div class="text_cart">В корзину</div>
				</div>
			</div>
	...
	<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
		<div class="item_goods">
			<div class="img_wrapper">
				<img src="img/article_2.jpg" alt="Автосигнализация Pandora DXL 3970 PRO ver.2">
				<div class="dark">
					<div class="text_cart">В корзину</div>
				</div>
			</div>
...
*/?>
	...
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<div class="head_h1"><? echo GetMessage('CVP_TPL_MESS_RCM') ?></div>
	</div>
	<?/*
	...
	*/?>
	...
	<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4" id="<? echo $strMainID; ?>">
	<div class="item_goods">
	<div class="img_wrapper">
		<img src="<?=$arItem['PREVIEW_PICTURE']['SRC']?>" alt="<?=$arItem['PREVIEW_PICTURE']['ALT']?>">
		<a href="<? echo $arItem['DETAIL_PAGE_URL']; ?>" rel="nofollow">
			<div class="dark">
				<div class="text_cart">Подробнее</div>
			</div>
		</a>
	</div>
	...
	<? if ($arParams['SHOW_NAME'] == "Y")
	{
		...
		<div class="col-xs-12">
			<div class="row">
				<a href="<? echo $arItem['DETAIL_PAGE_URL']; ?>" class="name"><?=$productTitle; ?></a>
			</div>
		</div>
		<?/*
			...
			if ($arItem['CAN_BUY'])
			{
				if ('Y' == $arParams['USE_PRODUCT_QUANTITY'])
				{
					...
					<div class="col-md-8 col-xs-12">
						<div class="row">
							<div class="counter">
								<a id="<? echo $arItemIDs['QUANTITY_DOWN']; ?>" href="javascript:void(0)" class="minus" rel="nofollow">&minus;</a>
								<input type="text" class="value" id="<? echo $arItemIDs['QUANTITY']; ?>" name="<? echo $arParams["PRODUCT_QUANTITY_VARIABLE"]; ?>" value="<? echo $arItem['CATALOG_MEASURE_RATIO']; ?>" style="border:none;">
								<a id="<? echo $arItemIDs['QUANTITY_UP']; ?>" href="javascript:void(0)" class="plus" rel="nofollow">&plus;</a>
								<?/*
				...
				<div class="col-xs-12">
					<div class="buy_button">
						<a id="<? echo $arItemIDs['BUY_LINK']; ?>" class="btn_site btn_red" href="javascript:void(0)" rel="nofollow"><?
