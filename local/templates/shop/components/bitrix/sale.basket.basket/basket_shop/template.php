...
if (empty($arResult['ERROR_MESSAGE']))
{
	...
	<section id="basket-root" class="cart">
		<div class="container">
			...
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" id="basket-items-list-wrapper">
				<table class="table_cart" id="basket-item-table">
					<tr class="header">
						<th>№</th>
						<th>Артикул</th>
						<th>Фото</th>
				...
				{
					?>
					<div class="cart_sum_block text-right" data-entity="basket-total-block"></div>
					<?
				}
				?>
			</div>
