...
<div class="img_wrapper">
	<img src="<?=$item['PREVIEW_PICTURE']['SRC']?>" alt="Автосигнализация Pandora DXL 3970 PRO ver.2">
	<div class="dark" id="<?=$itemIds['BASKET_ACTIONS']?>">
		<a id="<?=$itemIds['BUY_LINK']?>"
			href="javascript:void(0)" rel="nofollow"><div class="text_cart">
			<?=($arParams['ADD_TO_BASKET_ACTION'] === 'BUY' ? $arParams['MESS_BTN_BUY'] : $arParams['MESS_BTN_ADD_TO_BASKET'])?>
		</div></a>
	</div>
</div>
<a href="<?=$item['DETAIL_PAGE_URL']?>" class="name"><?=$item['NAME']?></a>
<div class="price"  id="<?=$itemIds['PRICE']?>"><?=$price['PRINT_RATIO_PRICE'];?></div>
<div class="counter">
	<div class="minus" id="<?=$itemIds['QUANTITY_DOWN']?>">&minus;</div>
	<input class="value" id="<?=$itemIds['QUANTITY']?>"
		name="<?=$arParams['PRODUCT_QUANTITY_VARIABLE']?>"
		value="<?=$measureRatio?>"
		style="border: none;">
	<div class="plus" id="<?=$itemIds['QUANTITY_UP']?>">&plus;</div>
</div>
<a id="<?=$itemIds['BUY_LINK']?>" href="javascript:void(0)"class="btn_site btn_red add_to_cart">
<?=($arParams['ADD_TO_BASKET_ACTION'] === 'BUY' ? $arParams['MESS_BTN_BUY'] : $arParams['MESS_BTN_ADD_TO_BASKET'])?>
</a>
