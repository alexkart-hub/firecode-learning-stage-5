		...
		foreach ($arResult['ITEM_ROWS'] as $rowData)
		{
			...
			<div class="row <?=$rowData['CLASS']?>" data-entity="items-row">
				...
				switch ($rowData['VARIANT'])
				{
					case 0:
						?>
						<div class="col-xs-12 product-item-small-card">01
							<div class="row">02
								<div class="col-xs-12 product-item-big-card">03
									<div class="row">04
										<div class="col-md-12">05
											<?
											$item = reset($rowItems);
					...
					case 1:
						?>
						<div class="col-xs-12 product-item-small-card">11
							<div class="row">12
								<?
								foreach ($rowItems as $item)
								{
									?>
									<div class="col-xs-6 product-item-big-card">13
										<div class="row">14
											<div class="col-md-12">15
												<?
												$APPLICATION->IncludeComponent(
													'bitrix:catalog.item',
													'',
					...
					case 2:
						?>
						<div class="col-xs-12 product-item-small-card">21
							<div class="row">22
								<?
								foreach ($rowItems as $item)
								{
									?>
									<div class="col-sm-4 product-item-big-card">23
										<div class="row">24
											<div class="col-md-12">25
												<?
												$APPLICATION->IncludeComponent(
													'bitrix:catalog.item',
													'',
					...
					case 3:
						?>
						<div class="col-xs-12 product-item-small-card">31
							<div class="row">32
								<?
								foreach ($rowItems as $item)
								{
									?>
									<div class="col-xs-6 col-md-3">33
										<?
										$APPLICATION->IncludeComponent(
											'bitrix:catalog.item',
											'',
