	...
	<div class="container" data-entity="<?=$containerName?>">
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<div class="head_h2">Новые товары</div>
			</div>
		...
		foreach ($arResult['ITEM_ROWS'] as $rowData)
		{
			...
			?>
				...
				switch ($rowData['VARIANT'])
				{
					case 0:
						?>
						<div class="col-xs-12 product-item-small-card">0
							<div class="row">
...
<?/*
					...
					case 4:
						...
						<div class="col-sm-6 product-item-small-card">4_2
							<div class="row">
								<?
					...
					case 5:
						$rowItemsCount = count($rowItems);
						?>
						<div class="col-sm-6 product-item-small-card">5
							<div class="row">
								<?
								for ($i = 0; $i < $rowItemsCount - 1; $i++)
								{
						...
						<div class="col-sm-6 product-item-big-card">5_2
							<div class="row">
								<div class="col-md-12">
									<?
									$item = end($rowItems);
					...
					case 6:
						?>
						<div class="col-xs-12 product-item-small-card">6
							<div class="row">
								<?
								foreach ($rowItems as $item)
								{
					...
					case 7:
						...
						<div class="col-sm-6 product-item-small-card">7_2
							<div class="row">
								<?
								for ($i = 0; $i < $rowItemsCount - 1; $i++)
								{
					...
					case 8:
						$rowItemsCount = count($rowItems);
						?>
						<div class="col-sm-6 product-item-small-card">8
							<div class="row">
								<?
								for ($i = 0; $i < $rowItemsCount - 1; $i++)
								{
						...
						<div class="col-sm-6 product-item-big-card">8_2
							<div class="row">
								<div class="col-md-12">
									<?
									$item = end($rowItems);
