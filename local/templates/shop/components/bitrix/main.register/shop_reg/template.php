...
<form method="post" action="<?=POST_FORM_ACTION_URI?>" name="regform" enctype="multipart/form-data" class="reg_wrapper">
	<div class="reg_step reg_step_1">
		...
		<div class="row">
			...
			<?foreach ($arResult["SHOW_FIELDS"] as $FIELD):?>
				...
				<?else:?>
					<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
						<label for="#">
							<?=GetMessage("REGISTER_FIELD_".$FIELD)?><?if ($arResult["REQUIRED_FIELDS_FLAGS"][$FIELD] == "Y"):?><span>*</span><?endif?>
						</label>
						<?
						switch ($FIELD)
						{
							case "PASSWORD":
								?><input  class="input_site input_site_dark" size="30" type="password" name="REGISTER[<?=$FIELD?>]" value="<?=$arResult["VALUES"][$FIELD]?>" autocomplete="off" class="bx-auth-input" />
							...
							case "CONFIRM_PASSWORD":
								?><input  class="input_site input_site_dark" size="30" type="password" name="REGISTER[<?=$FIELD?>]" value="<?=$arResult["VALUES"][$FIELD]?>" autocomplete="off" /><?
								break;
							...
							case "PERSONAL_PHOTO":
							case "WORK_LOGO":
								?><input  class="input_site input_site_dark" size="30" type="file" name="REGISTER_FILES_<?=$FIELD?>" /><?
								break;
							...
							default:
								...
								<input  class="input_site<?=($FIELD=="PERSONAL_PHONE")?" phone ":" "?>input_site_dark" size="30" type="text" name="REGISTER[<?=$FIELD?>]" value="<?=$arResult["VALUES"][$FIELD]?>" /><?
			...
			<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
				<input type="submit" name="register_submit_button"  value="<?=GetMessage("AUTH_REGISTER")?>" class="btn_site btn_transparent">
			</div>
		</div>
	</div>
</form>
