        ...
        ?>
                ...
                foreach($arResult['FORM_FIELDS'] as $fieldCode => $arField):
                    ...
                    <?else:?>
                        <? if(!$arParams['HIDE_FIELD_NAME']): ?>
                            <label class="control-label" for="<?=$arField['ID']?>"><?=$arField['TITLE']?></label>
                        <? endif; ?>
                        <input class="input_site<?=($arField['TYPE'] == 'tel')?" phone":""?>" type="<?=$arField['TYPE'];?>" id="<?=$arField['ID']?>" name="<?=$arField['NAME']?>" <?=$arField['PLACEHOLDER_STR'];?> <?=$arField['REQ_STR']?> <?=$arField['MASK_STR']?>>
                    <?endif;
                endforeach;?>
            ...
            <?endif;?>
                ...
                <div class="col-xs-12">
                    ...
                    <button type="submit" class="btn_site btn_red" data-default="<?=$arParams['FORM_SUBMIT_VALUE']?>"><?=$arParams['FORM_SUBMIT_VALUE']?></button>
                </div>
            <?endif;?>
